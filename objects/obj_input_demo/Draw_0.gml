...
draw_sprite(spr_keyboard_icons, get_keyboard_icon_index(keyboard_lastkey, spr_keyboard_icons), room_width/2 - icon_half_size, 256 - icon_half_size);

// Feather disable once GM1029
draw_text(room_width/2, 384, string(last_button) + " - " + gamepad_constant_to_string(last_button));
draw_sprite(spr_xbox_series_gamepad_icons, get_gamepad_icon_index(last_button, spr_xbox_series_gamepad_icons), room_width/2 - icon_half_size, 464 - icon_half_size);