...
submenu[0] = instance_create_layer(0, 0, layer, obj_ugmls_column_menu);
...
submenu[1] = instance_create_layer(0, 0, layer, obj_ugmls_column_menu);
...
main_menu = instance_create_layer(32, 64, layer, obj_ugmls_nested_menu);
