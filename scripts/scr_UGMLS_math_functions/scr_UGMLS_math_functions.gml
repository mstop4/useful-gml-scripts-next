...
normalize_2d = method(undefined, function(_vec) {
...
normalize_3d = method(undefined, function(_vec) {
...
cross_product = method(undefined, function(_vec1, _vec2) {
	return new Vector3(
...
/// @returns {real}
cross_product_2d = method(undefined, function(_vec1, _vec2) {
...
/// @param {Struct.Vector3} _vec1
/// @param {Struct.Vector3} _vec2
cross_product_normalized = method(undefined, function(_vec1, _vec2) {
	var _xp = new Vector3(
		_vec1.y*_vec2.z - _vec1.z*_vec2.y,
		_vec1.z*_vec2.x - _vec1.x*_vec2.z,
		_vec1.x*_vec2.y - _vec1.y*_vec2.x
...
/// @param {real} _min 
/// @param {real} _max
pulse = method(undefined, function(_t, _min, _max) {
...
/// @param {real} _w1
/// @param {real} _w2
blin = method(undefined, function(_a, _b, _c, _d, _w1, _w2) {
...
/// @param {real} _delta     
/// @param {real} _max            
soft_ceiling = method(undefined, function(_value, _delta, _max) {
...
/// @param {real} _min            
/// @param {real} _max            
soft_clamp = method(undefined, function(_value, _delta, _min, _max) {
...
/// @param {real} _min   
/// @param {real} _max   
wrap = method(undefined, function(_value, _min, _max) {
