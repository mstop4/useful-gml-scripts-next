...
draw_circle_meter(surf_circle, 128, 128, 128, 45, 1, percentage.v, _colour, c_gray, spr_meter, 100);
draw_surface_ext(surf_circle, 32, 64, 1, 1, 0, c_white, alpha.v);

// Feather disable once GM1041
draw_curved_meter(surf_curved, 128, 128, 64, 128, 30, 240, -1, percentage.v, _colour, c_gray, spr_donut_meter, 100);
