...
if (instance_exists(inst_id_h)) {
	var _h_input = real(keyboard_check_pressed(vk_right)) - real(keyboard_check_pressed(vk_left));
...
if (instance_exists(inst_id_v)) {
	var _v_input = real(keyboard_check_pressed(vk_down)) - real(keyboard_check_pressed(vk_up));
